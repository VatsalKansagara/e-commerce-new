...
export default function FilterSection({search, setSearch, brand, setBrand, category, setCategory, priceRange, setPriceRange, handleBrandChange, handleCategoryChange}) {
    const {categoryOnlyData, brandOnlyData} = getData();

    return (
      <div className='bg-grey-100 mt-10 p-4 rounded-md h-max hidden md:block'>
