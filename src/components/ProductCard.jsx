...
export default function ProductCard({product}) {
  ...
  return (
    <div className='border relative border-gray-100 rounded-2xl cursor-pointer hover:scale-105
        ...
        <button onClick={() => addToCart(product)} className='bg-red-500 px-3 py-2 text-sm md:text-lg rounded-md text-white w-full cursor-pointer
        flex gap-2 items-center justify-center font-semibold'><IoCartOutline className='w-6 h-6'/> Add to Cart</button>
    </div>
  )
}
