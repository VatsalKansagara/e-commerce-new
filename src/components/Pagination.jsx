...
export default function Pagination({page, pageHandler, dynamicPage}) {
  ...
  return (
    <div className='mt-10 space-x-4'>
        <button disabled={page == 1} className={`${page == 1 ? "bg-red-400" : "bg-red-500"} text-white 
        ...
        <button disabled={page == dynamicPage} className={`${page == dynamicPage ? "bg-red-400" : "bg-red-500"} text-white 
            px-3 py-1 rounded-md cursor-pointer`}
            onClick={() => pageHandler(page+1)}
        >Next</button>
    </div>
